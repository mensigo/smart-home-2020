...
public class DoorCloseByIdInHallEffectAction implements Action {
    ...
    public DoorCloseByIdInHallEffectAction(String objectId, String hallName, boolean isQuiet, CommandSender commandSender) {
